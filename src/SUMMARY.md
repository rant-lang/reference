...
- [Language](language.md)
    ...
    - [Collections](language/collections.md)
        - [List](language/collections/list.md)
        - [Tuple](language/collections/tuple.md)
        - [Map](language/collections/map.md)
        - [Range](language/collections/range.md)
        - [String](language/collections/string.md)
